...
extension WorkEntryQueryFilter
  ...
  QueryBuilder<WorkEntry, WorkEntry, QAfterFilterCondition> endIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<WorkEntry, WorkEntry, QAfterFilterCondition> endIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<WorkEntry, WorkEntry, QAfterFilterCondition> endEqualTo(
      DateTime? value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<WorkEntry, WorkEntry, QAfterFilterCondition> endGreaterThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<WorkEntry, WorkEntry, QAfterFilterCondition> endLessThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<WorkEntry, WorkEntry, QAfterFilterCondition> endBetween(
    DateTime? lower,
    DateTime? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<WorkEntry, WorkEntry, QAfterFilterCondition> startEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'start',
  ...
  QueryBuilder<WorkEntry, WorkEntry, QAfterFilterCondition> startGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<WorkEntry, WorkEntry, QAfterFilterCondition> startLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<WorkEntry, WorkEntry, QAfterFilterCondition> startBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension WorkEntryQuerySortBy on QueryBuilder<WorkEntry, WorkEntry, QSortBy> {
  QueryBuilder<WorkEntry, WorkEntry, QAfterSortBy> sortByEnd() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'end', Sort.asc);
    });
  }

  QueryBuilder<WorkEntry, WorkEntry, QAfterSortBy> sortByEndDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'end', Sort.desc);
    });
  }

  QueryBuilder<WorkEntry, WorkEntry, QAfterSortBy> sortByStart() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'start', Sort.asc);
    });
  }

  QueryBuilder<WorkEntry, WorkEntry, QAfterSortBy> sortByStartDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension WorkEntryQuerySortThenBy
  ...
  QueryBuilder<WorkEntry, WorkEntry, QAfterSortBy> thenByEnd() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'end', Sort.asc);
    });
  }

  QueryBuilder<WorkEntry, WorkEntry, QAfterSortBy> thenByEndDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'end', Sort.desc);
    });
  }
  ...
  QueryBuilder<WorkEntry, WorkEntry, QAfterSortBy> thenByStart() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'start', Sort.asc);
    });
  }

  QueryBuilder<WorkEntry, WorkEntry, QAfterSortBy> thenByStartDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'start', Sort.desc);
    });
  }
...
extension WorkEntryQueryWhereDistinct
  ...
  QueryBuilder<WorkEntry, WorkEntry, QDistinct> distinctByEnd() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'end');
    });
  }

  QueryBuilder<WorkEntry, WorkEntry, QDistinct> distinctByStart() {
    return QueryBuilder.apply(this, (query) {
...
extension WorkEntryQueryProperty
  ...
  QueryBuilder<WorkEntry, DateTime?, QQueryOperations> endProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'end');
    });
  }

  QueryBuilder<WorkEntry, DateTime, QQueryOperations> startProperty() {
    return QueryBuilder.apply(this, (query) {
